...
//            List<Bill> billList = billService.findAllByUserAndStatus(user, 0);
...
public String PaymentConfirmPage(@RequestParam(required = false, name = "address") String address,
    ...
    if(user == null){
        ...
        if(billCheck.isPresent()){
            ...
            billService.saveBill(bill);
            attributes.addFlashAttribute("message", "Đang Xác Nhận Thanh toán Vui Lòng Chờ !!!");
